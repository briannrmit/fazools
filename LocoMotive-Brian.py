...
class mainPlayingBoard(object):
    ...
    def displayRouteCards(self):
        ...
        w = Canvas(toplevel, width=500, height=700)
        w.pack()
...
class panel:
    def __init__(self, panelNo):
        global index
        global keptRouteCardList
        global blankPILImage
        self.position = panelNo
        
        blankPILImage = Image.new("RGB",(200,152),"#DCDCDC")
        ni = blankPILImage.convert("RGB")
        blankPILImage = ImageTk.PhotoImage(image = ni)
        if len(keptRouteCardList) > (self.position + index):
            self.panel = Button(w, image=keptRouteCardList[self.position + index])
        else:
            self.panel = Button(w, image=blankPILImage)
        self.panel.pack(side=LEFT)

    def refresh(self):
        global blankPILImage
        if len(keptRouteCardList) > (self.position + index):
            self.panel.config(image=keptRouteCardList[self.position + index])
        else:
            self.panel.config(image = blankPILImage)
...
def mtIsaToBourke(): #17
    claimedSpacesX.append(int(math.floor(screenWidth*0.485)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.380)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.490)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.410)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.487)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.440)))
...
def sydneyToBourke(): #18

    claimedSpacesX.append(int(math.floor(screenWidth*0.510)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.550)))
...
def bourkeToBrokenHill():#19
    claimedSpacesX.append(int(math.floor(screenWidth*0.470)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.490)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.453)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.510)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.448)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.540)))
...
def sydneyToCanberra():  #20
    claimedSpacesX.append(int(math.floor(screenWidth*0.540)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.562)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.520)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.580)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.510)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.607)))
...
def brokenHillToMelbs():  #21
    claimedSpacesX.append(int(math.floor(screenWidth*0.454)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.580)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.450)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.621)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.456)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.660)))
...
def canberraToMelbs(): #22
    claimedSpacesX.append(int(math.floor(screenWidth*0.503)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.650)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.495)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.670)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.473)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.680)))
...
def sydneyToMelbs(): #23
    claimedSpacesX.append(int(math.floor(screenWidth*0.557)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.600)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.545)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.630)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.535)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.655)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.522)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.680)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.500)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.700)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.475)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.700)))
...
def melbsToHobart(): #24
    claimedSpacesX.append(int(math.floor(screenWidth*0.455)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.705)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.455)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.735)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.455)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.765)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.460)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.790)))
...
def melbsToPortland(): #25
    claimedSpacesX.append(int(math.floor(screenWidth*0.445)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.695)))
...
def adelaideToPortland(): #26
    claimedSpacesX.append(int(math.floor(screenWidth*0.411)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.580)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.425)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.609)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.426)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.640)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.423)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.670)))
...
def adelaideToCooberPedy(): #27
    claimedSpacesX.append(int(math.floor(screenWidth*0.453)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.560)))
...
def adelaideToCeduna():  #28
    claimedSpacesX.append(int(math.floor(screenWidth*0.380)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.580)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.360)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.577)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.345)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.560)))
...
def mackayToMtIsa():  #29
    claimedSpacesX.append(int(math.floor(screenWidth*0.493)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.273)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.485)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.299)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.477)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.330)))
...
def adelaideToBorderVillage(): #30
    claimedSpacesX.append(int(math.floor(screenWidth*0.385)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.560)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.370)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.540)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.349)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.530)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.325)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.533)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.299)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.535)))
...
def cedunaToBorderVillage():  #31
    claimedSpacesX.append(int(math.floor(screenWidth*0.315)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.560)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.293)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.560)))
...
def aliceToBorderVillage():  #32
    claimedSpacesX.append(int(math.floor(screenWidth*0.333)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.385)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.333)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.410)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.330)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.440)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.324)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.465)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.310)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.488)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.296)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.516)))
...
def aliceToCooberPedy(): #33
    claimedSpacesX.append(int(math.floor(screenWidth*0.345)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.364)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.360)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.390)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.364)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.415)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.369)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.450)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.368)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.480)))
...
def burketownToAlice():  #34
    claimedSpacesX.append(int(math.floor(screenWidth*0.394)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.255)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.390)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.280)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.380)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.305)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.365)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.330)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.346)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.348)))
...
def darwinToBroome():  #35
    claimedSpacesX.append(int(math.floor(screenWidth*0.285)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.123)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.263)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.140)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.245)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.160)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.235)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.180)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.220)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.200)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.210)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.220)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.190)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.240)))
...
def aliceToHallsCreek():  #36
    claimedSpacesX.append(int(math.floor(screenWidth*0.300)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.370)))
...
def broomeToHallsCreek():  #37
    claimedSpacesX.append(int(math.floor(screenWidth*0.200)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.250)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.225)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.252)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.234)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.275)))
...
def broomeToKaratha():  #38
    claimedSpacesX.append(int(math.floor(screenWidth*0.174)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.276)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.165)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.295)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.145)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.310)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.124)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.325)))
...
def broomeToNewman():  #39
    claimedSpacesX.append(int(math.floor(screenWidth*0.195)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.275)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.193)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.305)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.182)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.330)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.165)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.355)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.150)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.375)))
...
def karathaToNewman():  #40
    claimedSpacesX.append(int(math.floor(screenWidth*0.120)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.345)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.135)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.370)))
...
def karathaToExmouth():   #41
    claimedSpacesX.append(int(math.floor(screenWidth*0.100)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.345)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.090)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.365)))
...
def exmouthToCarnarvan():  #42
    claimedSpacesX.append(int(math.floor(screenWidth*0.075)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.400)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.075)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.425)))
...
def carnarvanToMtMagnet():  #43
    claimedSpacesX.append(int(math.floor(screenWidth*0.096)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.467)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.115)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.480)))
...
def newmanToMtMagnet():  #44
    claimedSpacesX.append(int(math.floor(screenWidth*0.125)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.405)))
...
def newmanToKarlgoolieB():  #46
    claimedSpacesX.append(int(math.floor(screenWidth*0.145)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.410)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.155)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.440)))
...
def mtMagnetToKarlgoolie():  #47
    claimedSpacesX.append(int(math.floor(screenWidth*0.140)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.500)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.160)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.510)))
...
def karlgoolieToBorberVillageA():  #48
    claimedSpacesX.append(int(math.floor(screenWidth*0.453)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.120)))
...
def karlgoolieToBorberVillageB():  #49
    claimedSpacesX.append(int(math.floor(screenWidth*0.190)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.490)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.208)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.505)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.230)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.515)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.250)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.525)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.266)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.535)))
...
def esperanceToBorderVillage():  #50
    claimedSpacesX.append(int(math.floor(screenWidth*0.230)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.580)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.250)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.590)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.275)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.585)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.280)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.560)))
...
def albanyToEsperance():  #51
    claimedSpacesX.append(int(math.floor(screenWidth*0.165)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.595)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.179)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.575)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.200)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.570)))
...
def albanyToBunbury():  #52
    claimedSpacesX.append(int(math.floor(screenWidth*0.145)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.625)))

    claimedSpacesX.append(int(math.floor(screenWidth*0.123)))
    claimedSpacesY.append(int(math.floor(screenHeight*0.625)))
