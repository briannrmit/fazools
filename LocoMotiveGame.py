...
#width, height = Image.open(image.png).size
    def __init__(self,master):
        ...
        photoLabel1.pack()
        self.c.create_image(0,790, image=image1,anchor = SW)
        ...
        photoLabel3.pack()
        self.c.create_image(10,800, image=image3,anchor = NW)
        image4 = ImageTk.PhotoImage(file="carriage_yellow.png")
        photoLabel4=Label(image=image4)
        photoLabel4.image=image4
        photoLabel4.pack()
        self.c.create_image(240,800, image=image4,anchor = NW)
        image5 = ImageTk.PhotoImage(file="carriage_red.png")
        photoLabel5=Label(image=image5)
        photoLabel5.image=image5
        photoLabel5.pack()
        self.c.create_image(470,800, image=image5,anchor = NW)
        image6 = ImageTk.PhotoImage(file="carriage_green.png")
        photoLabel6=Label(image=image6)
        photoLabel6.image=image6
        photoLabel6.pack()
        self.c.create_image(700,800, image=image6,anchor = NW)
        image7 = ImageTk.PhotoImage(file="carriage_orange.png")
        photoLabel7=Label(image=image7)
        photoLabel7.image=image7
        photoLabel7.pack()
        self.c.create_image(930,800, image=image7,anchor = NW)
        image8 = ImageTk.PhotoImage(file="carriage_pink.png")
        photoLabel8=Label(image=image8)
        photoLabel8.image=image8
        photoLabel8.pack()
        self.c.create_image(1160,800, image=image8,anchor = NW)
        image9 = ImageTk.PhotoImage(file="train_card.png")
        photoLabel9=Label(image=image9)
        photoLabel9.image=image9
        photoLabel9.pack()
        self.c.create_image(1400,800, image=image9,anchor = NW)
        self.c.create_text(170, 840, fill="green", font="courier 25 bold", text ="x "+str(p1BlueNum), width=1200, anchor="nw")
        self.c.create_text(400, 840, fill="green", font="courier 25 bold", text ="x "+str(p1YellowNum), width=1200, anchor="nw")
        self.c.create_text(630, 840, fill="green", font="courier 25 bold", text ="x "+str(p1RedNum), width=1200, anchor="nw")
        self.c.create_text(860, 840, fill="green", font="courier 25 bold", text ="x "+str(p1GreenNum), width=1200, anchor="nw")
        self.c.create_text(1090, 840, fill="green", font="courier 25 bold", text ="x "+str(p1OrangeNum), width=1200, anchor="nw")
        self.c.create_text(1330, 840, fill="green", font="courier 25 bold", text ="x "+str(p1PinkNum), width=1200, anchor="nw")
        self.c.create_text(1560, 840, fill="green", font="courier 25 bold", text ="x "+str(p1LocoNum), width=1200, anchor="nw")
