...
canvas.create_image(-70,740, image=image,anchor = SW)
root.title('Loco Motive')

#option menu buttons hosting area
pickcarriagecard_button = tk.Button(root, text = "Pick up carriage card",font=("courier", 15),  command = root.quit, anchor = 'w',width = 16,height = 2,
                       activebackground = "#33B5E5")
pickcarriagecard_button_window = canvas.create_window(1070, 180, anchor='nw', window=pickcarriagecard_button)    
pickroute_button = tk.Button(root, text = "Pick up route card",font=("courier", 15),  command = root.quit, anchor = 'w',
...
scoreboard_button = tk.Button(root, text = "               Score Board",font=("courier", 15), command = root.quit, anchor = 'w',
...
carriagecard1_button = tk.Button(root, text = "      Carriage Card", command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard1_button_window = canvas.create_window(20, 745, anchor='nw', window=carriagecard1_button)

carriagecard2_button = tk.Button(root, text = "      Carriage Card", command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard2_button_window = canvas.create_window(160, 745, anchor='nw', window=carriagecard2_button)
carriagecard3_button = tk.Button(root, text = "      Carriage Card", command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard3_button_window = canvas.create_window(300, 745, anchor='nw', window=carriagecard3_button)

carriagecard4_button = tk.Button(root, text = "      Carriage Card", command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard4_button_window = canvas.create_window(438, 745, anchor='nw', window=carriagecard4_button)

carriagecard5_button = tk.Button(root, text = "      Carriage Card", command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard5_button_window = canvas.create_window(576, 745, anchor='nw', window=carriagecard5_button)

carriagecard6_button = tk.Button(root, text = "      Carriage Card", command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard6_button_window = canvas.create_window(717, 745, anchor='nw', window=carriagecard6_button)

carriagecard7_button = tk.Button(root, text = "      Carriage Card", command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard7_button_window = canvas.create_window(855, 745, anchor='nw', window=carriagecard7_button)

carriagecard8_button = tk.Button(root, text = "      Carriage Card", command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard8_button_window = canvas.create_window(995, 745, anchor='nw', window=carriagecard8_button)

carriagecard9_button = tk.Button(root, text = "      Carriage Card", command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard9_button_window = canvas.create_window(1147, 745, anchor='nw', window=carriagecard9_button)

carriagecard10_button = tk.Button(root, text = "      Carriage Card", command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard10_button_window = canvas.create_window(20, 793, anchor='nw', window=carriagecard10_button)

carriagecard11_button = tk.Button(root, text =" Carriage Card", command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard11_button_window = canvas.create_window(170, 793, anchor='nw', window=carriagecard11_button)

carriagecard12_button = tk.Button(root, text = " Carriage Card",command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard12_button_window = canvas.create_window(320, 793, anchor='nw', window=carriagecard12_button)

carriagecard13_button = tk.Button(root, text = " Carriage Card", command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard13_button_window = canvas.create_window(460, 793, anchor='nw', window=carriagecard13_button)

carriagecard14_button = tk.Button(root, text = " Carriage Card", command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard14_button_window = canvas.create_window(590, 793, anchor='nw', window=carriagecard14_button)

carriagecard15_button = tk.Button(root, text = " Carriage Card", command = root.quit, anchor = 'w',
                    width =16,height = 2, activebackground = "#33B5E5")
carriagecard15_button_window = canvas.create_window(720, 793, anchor='nw', window=carriagecard15_button)
